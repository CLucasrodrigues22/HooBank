...
export const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className={`flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2`}>
        ...
        <p className={`${styles.paragraph} ml-2`}>
          ...
          </span> de Desconto durante {" "}
          <span className='text-white'>1 mês
          </span> de conta.
        </p>
      </div>
      ...
      <div className='flex flex-row justify-between items-center w-full'>
        <h1 className='flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]'>
          Um novo <br className='sm:block hidden' /> {" "} <span className='text-gradient'>conceito
          </span> {" "}
        </h1>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        ...
        Examinamos taxas percentuais anuais, taxas anuais.
      </p>
    </div>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className='absolute z-[2] w-[50%] h-[50%] right-20 bottom-20 pink__gradient' />
